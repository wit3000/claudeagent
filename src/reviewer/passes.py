...
- В чём ошибка: 2–4 полных предложения: что именно не так, какое правило/ожидание нарушено, и почему это важно для читателя. Без воды, но с конкретикой.
- Как исправить: дай конкретную замену — как должно быть написано, дословно (до трёх альтернатив, если уместно). Абстрактные советы («сделай понятнее») не принимаются.
...
- Место: Абзац N, предложение M.
- В чём проблема: 2–4 полных предложения: что именно не так, какое логическое правило/ожидание нарушено, и почему это важно для читателя. Без воды, но с конкретикой.
- Как исправить: дай конкретную замену — как должно быть написано, дословно (до трёх альтернатив, если уместно). Абстрактные советы («сделай понятнее») не принимаются.
...
- Место: Абзац N, предложение M.
- Что произошло при чтении: 2–4 полных предложения: что именно не сработало, какое ожидание читателя нарушено, и почему это мешает понять текст. Без воды, но с конкретикой.
- Что помогло бы читателю: дай конкретную замену — как должно быть написано, дословно (до трёх альтернатив, если уместно). Абстрактные советы («сделай понятнее») не принимаются.
